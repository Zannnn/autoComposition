...
meanless_file = "/pub/data/lz/autoComposition/autocomp_master/dataset/BSDSAandCOCOA/meanless_class_COCOA.txt"

# 输出路径
output_filefold = "/pub/data/lz/autoComposition/autocomp_master/dataset/forComp_COCOA_occlude_filter/"
...
for annotation in tqdm(data["annotations"]):
    ...
    for idx, region in enumerate(annotation["regions"]):
        ...
        if occ_rate == 0:   # 不遮挡
            ...
            image_path = os.path.join(image_root, image_info["file_name"])     #看这里前面要不要加前缀
